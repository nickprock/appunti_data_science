...
I notebook 1, 6, 8 sono apparsi come articoli per il [blog di IAML](https://iaml.it/blog).
...
The code present in this project is licensed under the GNU GENERAL PUBLIC LICENSE v4.0.
